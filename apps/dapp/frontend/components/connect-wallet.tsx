...
function WalletGridCard({
    ...
    return (
        <button
            ...
            className="group flex h-[84px] w-full flex-col items-center justify-center gap-2 rounded-xl border border-border bg-white transition-all hover:-translate-y-[2px] hover:border-black/20 hover:shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
        >
...
function WalletListItem({
    ...
    return (
        <button
            onClick={() => onSelect(wallet.id)}
            disabled={isConnecting}
            className="group flex w-full items-center gap-3 rounded-xl border border-border bg-white p-3 transition-all hover:border-black/20 hover:shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
        >
        ...
        <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-4 bg-background">
            ...
            >
                ...
                <motion.h1
                    ...
                    className="mb-3 text-center font-heading text-3xl font-light tracking-tight text-foreground sm:text-4xl"
                >
                    Welcome to{" "}
                ...
                <motion.p
                    ...
                    className="mb-8 max-w-sm text-center text-base text-muted-foreground leading-relaxed"
                >
                ...
                >
                    ...
                    <div className="rounded-3xl border border-border bg-white px-6 py-5 shadow-xl shadow-black/[0.03]">
                        ...
                        {!walletsLoaded ? (
                            ...
                            <>
                                ...
                                {/* Featured wallets */}
                                <div className="mx-auto grid w-full max-w-[320px] grid-cols-3 gap-3 mb-3">
                                ...
                                {remaining.length > 0 && (
                                    <motion.button
                                        ...
                                        className="flex w-full items-center justify-center gap-2 rounded-xl border border-dashed border-border py-2.5 text-xs font-medium text-muted-foreground transition-all hover:border-black/20 hover:text-foreground"
                                    >
                                        {showAll
                                            ? "Show less"
